    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header">Pieejamie dalībnieki</h1>
          ...
          <?php 
            $sql = "SELECT * FROM users WHERE id NOT IN (SELECT user_id from participants where travel_group_id =" . $_GET['tg_id'] .");";
            ...
            foreach ($query as $row) { 
                echo    "<tr><td>" . $row['name'] . "</td>
                        ...
                        <td>" . $row['wantVisit'] . "</td>
                        <td>". $row['interests'] . "</td>
                        <td><a href='addParticipant.php?user_id=". $row['id'] ."&tg_id=" . $_GET['tg_id'] . "' title='Delete Record' data-toggle='tooltip'><input type='button' class='btn btn-success' value='Pievienot'</a>
                        </td></tr>";
            }
            ?>  
            </tbody>
