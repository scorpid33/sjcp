      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
		    <li><a href="../admin/index2.php">Add Test </a></li>
            <li><a href="../admin/index.php">Add Questions </a></li>
            <li class="active"><a href="../admin/index3.php">Delete Test <span class="sr-only">(current)</span></a></li>
          </ul>
        </div>
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header">Delete Test</h1>
			<?php
